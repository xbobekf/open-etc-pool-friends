...
import (
	"github.com/xbobekf/open-etc-pool-friends/api"
	"github.com/xbobekf/open-etc-pool-friends/exchange"
	"github.com/xbobekf/open-etc-pool-friends/payouts"
	"github.com/xbobekf/open-etc-pool-friends/policy"
